...
public class OBRR extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        goForward(1, 1000); //to knock the jewel off
        goBack(1,1000); //just a little to have room to turn
        rotateRight(1, 1000); //face perpendicular to the center line
        goForward(1, 1000); //get passed the balancing stone
        rotateLeft(1, 1000); //90˚ around the balancing stone
